public class Scanner {
    ...
    private static void readNumber(Token t) {
        ...
        for (; ; ) {
            ...
            if (decPointCount > 1) throw new IllegalArgumentException("Number token contains too many decimal points");
    ...
    public static Token token;  // zuletzt erkanntes src.Token
